...
var questions = [
    ...
    if (correct < 17) {
      ...
      test.innerHTML = "<h4 style= 'color: rgb(156, 26, 8)'>"+question+"</h4>";
      // display the answer options
      test.innerHTML += "<label style= 'color:rgb(18, 56, 136); font-size:35px; font-weight:bold'> <input type='radio' name='options' value='A'> "+opA+"</label><br>";
      test.innerHTML += "<label style= 'color:rgb(18, 56, 136); font-size:35px; font-weight:bold'> <input type='radio' name='options' value='B'> "+opB+"</label><br><br>";
      test.innerHTML += "<button style= 'color: rgb(37, 27, 21); background-color:rgb(252, 249, 95); font-size:30px; font-weight:bold' onclick='checkAnswer()'>Next &#9658</button>";
     }
